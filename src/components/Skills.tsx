    ...
    <section id="skills" className="shell section-pad">
      ...
      <div className="grid grid-cols-2 gap-[18px] max-[760px]:grid-cols-1">
        {CATEGORIES.map((c) => (
          <div
            key={c.key}
            className="bg-bg border border-line px-7 py-[26px] rounded-[var(--radius-lg)] relative transition-all duration-[180ms] hover:border-ink hover:-translate-x-[3px] hover:-translate-y-[3px] hover:shadow-[6px_6px_0_var(--color-blue)]"
          >
      ...
      <div className="mt-7 flex flex-wrap gap-6 px-6 py-5 border border-dashed border-line-strong rounded-[var(--radius-lg)] font-mono text-xs text-ink-3">
